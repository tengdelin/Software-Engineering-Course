...
<div class="address">
    <div class="wrapper clearfix">
        ...
        <span>/</span>
        <a href="test.jsp" class="on">考研书籍</a>
        <span>/</span>
...
<div class="paintCon">
    ...
    <div class="paintList">
        ...
        <dl>
            <dt><img src="img/temp/kaoyan.jpeg"></dt>
            <dd>考研书籍</dd>
            <!-- <dd>￥299.90</dd> -->
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/jiayou.jpg"></dt>
            <dd>考研材料</dd>
            <!-- <dd>￥299.90</dd> -->
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/ky.jpg"></dt>
            <dd>考研院校信息</dd>
            <!-- <dd>￥299.90</dd> -->
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/kyyx.jpg"></dt>
            <dd>考研专业材料</dd>
            <!-- <dd>￥299.90</dd> -->
        </dl>
    </a>
