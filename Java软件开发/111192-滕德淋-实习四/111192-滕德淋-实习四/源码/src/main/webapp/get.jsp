...
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a>
        ...
        <span>/</span>
        <a href="get.jsp" class="on">代取快递</a>
        <span>/</span>
...
<div class="paintList"><a href=" ">
    <dl>
        <dt><img src="img/temp/手表代取.jpg"></dt>
        <dd>手表代取</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/洗衣液代取.jpg"></dt>
        <dd>洗衣液代取</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/衣服代取.jpg"></dt>
        <dd>衣服代取</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/裤子代取.jpg"></dt>
        <dd>裤子代取</dd>
    </dl>
</a></div>
...
<div class="paintList"><a href=" ">
    <dl>
        <dt><img src="img/temp/鞋子代取.jpg"></dt>
        <dd>鞋子代取</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/项链代取.jpg"></dt>
        <dd>项链代取</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/手镯代取.jpg"></dt>
        <dd>手镯代取</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/帽子代取.jpg"></dt>
        <dd>帽子代取</dd>
    </dl>
</a></div>
