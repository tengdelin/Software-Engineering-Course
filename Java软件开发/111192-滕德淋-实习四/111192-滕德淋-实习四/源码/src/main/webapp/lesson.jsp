...
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a>
        ...
        <span>/</span>
        <a href="lesson.jsp" class="on">帮刷网课</a>
        <span>/</span>
...
<div class="paintCon">
    <div class="paintList"><a href=" ">
        <dl>
            <dt><img src="img/temp/wangke.jpg"></dt>
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/less.jpg"></dt>
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/ke.jpg"></dt>
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/shua.jpg"></dt>
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/kechen.jpg"></dt>
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/kec.jpg"></dt>
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/txkt.jpg"></dt>
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/chaox.jpg"></dt>
        </dl>
    </a></div>
    <!--footer-->
    <div class="footer">
