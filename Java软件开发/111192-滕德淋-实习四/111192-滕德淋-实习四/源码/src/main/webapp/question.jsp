...
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a>
        ...
        <span>/</span>
        <a href="question.jsp" class="on">题目问答</a>
        <span>/</span>
...
<div class="paintCon">
    <div class="paintList"><a href=" ">
        <dl>
            <dt><img src="img/temp/q1.png"></dt>
            <dd>怎么学习编程呢？</dd>
            <!-- <dd>￥299.90</dd> -->
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/q2.png"></dt>
            <dd>Java和C++的区别有什么呢？</dd>
            <!-- <dd>￥299.90</dd> -->
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/q3.png"></dt>
            <dd>大家都用哪些数据库呢？</dd>
            <!-- <dd>￥299.90</dd> -->
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/q4.png"></dt>
            <dd>进程的调度有哪些方式？</dd>
            <!-- <dd>￥299.90</dd> -->
        </dl>
