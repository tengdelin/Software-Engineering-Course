...
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a>
        ...
        <span>/</span>
        <a href="happy.jsp" class="on">乐跑互助</a>
        <span>/</span>
...
<div class="paintCon">
    <div class="paintList"><a href="  ">
        <dl>
            <dt><img src="img/temp/lepao.jpg"></dt>
        </dl>
    </a><a href="  ">
        <dl>
            <dt><img src="img/temp/paobu.jpg"></dt>
        </dl>
    </a><a href="  ">
        <dl>
            <dt><img src="img/temp/running.jpg"></dt>
        </dl>
    </a><a href="  ">
        <dl>
            <dt><img src="img/temp/run.jpg"></dt>
        </dl>
    </a><a href="  ">
        <dl>
            <dt><img src="img/temp/pao.jpg"></dt>
        </dl>
    </a><a href="  ">
        <dl>
            <dt><img src="img/temp/bu.jpg"></dt>
        </dl>
    </a><a href="  ">
        <dl>
            <dt><img src="img/temp/runn.jpg"></dt>
        </dl>
    </a><a href="  ">
        <dl>
            <dt><img src="img/temp/runned.jpg"></dt>
        </dl>
    </a></div>
