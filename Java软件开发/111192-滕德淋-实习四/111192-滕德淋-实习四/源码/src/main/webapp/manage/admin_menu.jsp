    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
                ...
                <li><a href="/Web03/index.jsp" target="">网站首页</a></li>
            </ul>
        </div>
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                ...
                <li><a href="/Web03/manage/adminlogout">退出</a></li>
            </ul>
        </div>
    </div>
</div>
            ...
            <ul class="sidebar-list">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li><a href="/Web03/manage/admin_cateselect"><i class="icon-font">&#xe008;</i>分类管理</a></li>
                        <li><a href="/Web03/manage/admin_productselect"><i class="icon-font">&#xe008;</i>悬赏管理</a></li>
