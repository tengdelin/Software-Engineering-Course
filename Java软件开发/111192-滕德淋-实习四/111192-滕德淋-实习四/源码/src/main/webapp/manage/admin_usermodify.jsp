...
<div class="main-wrap">
    ...
    <div class="crumb-wrap">
        <div class="crumb-list"><i class="icon-font"></i><a href="/Web03/manage/admin_index.jsp">首页</a><span
                class="crumb-step">&gt;</span><a class="crumb-name" href="/Web03/manage/admin_douserselect">用户管理</a><span
                class="crumb-step">&gt;</span><span>修改用户</span></div>
    </div>
    <div class="result-wrap">
        <div class="result-content">
            <form action="/Web03/manage/admin_douserupdate" method="post" id="myform" name="myform">
                ...
                <table class="insert-tab" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="common-text required" id="title" name="phone" size="50" value="${user.USER_MOBILE}" type="text">
                        </td>
                    </tr>
                    <tr>
