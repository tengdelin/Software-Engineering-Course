...
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a>
        ...
        <span>/</span>
        <a href="work.jsp" class="on">悬赏课设</a>
        <span>/</span>
...
<!-----------------paintCon------------------------------->
<div class="current">
    <div class="wrapper clearfix"><h3 class="fl">悬赏课设</h3>
        <div class="fr clearfix"><p class="fl"></p>
...
<div class="paintCon">
    <div class="paintList"><a href=" ">
        ...
        <dl>
            <dt><img src="img/temp/python.png"></dt>
            <dd>python课程设计</dd>
            <!-- <dd>￥299.90</dd> -->
        </dl>
    </a><a href=" ">
        <dl>
            <dt><img src="img/temp/JS.jpg"></dt>
            <dd>javascript</dd>
            <!-- <dd>￥299.90</dd> -->
        </dl>
