...
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a>
        ...
        <span>/</span>
        <a href="run.jsp" class="on">外卖跑腿</a>
        <span>/</span>
...
<div class="paintList"><a href=" ">
    <dl>
        <dt><img src="img/temp/盒饭代拿.jpg"></dt>
        <dd>盒饭代拿</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/食堂一代拿.jpg"></dt>
        <dd>食堂一代拿</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/小炒肉代拿.jpg"></dt>
        <dd>小炒肉代拿</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/小龙虾代拿.jpg"></dt>
        <dd>小龙虾代拿</dd>
    </dl>
</a></div>
...
<div class="paintList"><a href=" ">
    <dl>
        <dt><img src="img/temp/石锅饭代拿.jpg"></dt>
        <dd>石锅饭代拿</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/盖饭代拿.jpg"></dt>
        <dd>盖饭代拿</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/套餐代拿.jpg"></dt>
        <dd>套餐代拿</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/必胜客代拿.jpg"></dt>
        <dd>必胜客代拿</dd>
    </dl>
</a></div>
