    ...
    <div class="sidebar-wrap">
        ...
        <div class="sidebar-content">
            <ul class="sidebar-list">
                <li>
                    <a href="#"><i class="icon-font">&#xe003;</i>悬赏类别</a>
                    <ul class="sub-menu">
                        <li><a href=""><i class="icon-font">&#xe008;</i>学习类</a></li>
                        <li><a href=""><i class="icon-font">&#xe005;</i>生活类</a></li>
                        <li><a href=""><i class="icon-font">&#xe006;</i>校园类</a></li>
                        <li><a href=""><i class="icon-font">&#xe007;</i>其他</a></li>
                    </ul>
                </li>
            </ul>
        </div>
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="index.jsp">首页</a><span
                    class="crumb-step">&gt;</span><span class="crumb-name">悬赏发布</span></div>
        </div>
            ...
            <form action="/Web03/manage/admin_douserdel" id="myform" method="post">
                ...
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        <tr>
                            <th class="tc" width="5%"><input class="allChoose" name="" onclick="selall(this)"
                                                             type="checkbox"></th>
                            <th>ID</th>
                            <th>姓名</th>
                            <th>性别</th>
                        ...
                        <c:forEach var="u" items="${userlist}">
                            <tr>
                                ...
                                <td>
                                    <a class="link-update"
                                       href="admin_touserupdate?id=${u.USER_ID}&cpage=${cpage}">修改</a>
