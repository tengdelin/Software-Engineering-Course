...
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a>
        <span>/</span>
        <a href="#" class="on">舞动青春</a>
        <span>/</span>
        <a href="left.jsp" class="on">失物招领</a>
        <span>/</span>
...
<div class="paintList">
    <a href=" ">
        <dl>
            <dt><img src="img/temp/耳机.jpg"></dt>
            <dd>耳机 丢失 </dd>
        </dl>
    </a><a href=" ">
    <dl>
        <dt><img src="img/temp/钱包.jpg"></dt>
        <dd>小钱包 丢失</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/钥匙.jpg"></dt>
        <dd>钥匙 丢失</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/雨伞.jpg"></dt>
        <dd>雨伞 丢失</dd>
    </dl>
</a>
</div>
<div class="paintList">
    <a href=" ">
        <dl>
            <dt><img src="img/temp/手表.jpg"></dt>
            <dd>手表 丢失 </dd>
        </dl>
    </a><a href=" ">
    <dl>
        <dt><img src="img/temp/笔盒.jpg"></dt>
        <dd>笔盒 丢失</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/水杯.jpg"></dt>
        <dd>水杯 丢失</dd>
    </dl>
</a><a href=" ">
    <dl>
        <dt><img src="img/temp/校园卡.jpg"></dt>
        <dd>校园卡 丢失</dd>
    </dl>
</a>
</div>
