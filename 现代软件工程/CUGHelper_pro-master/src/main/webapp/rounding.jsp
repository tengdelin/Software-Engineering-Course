...
<!-----------------address------------------------------->
<div class="address">
    <div class="wrapper clearfix"><a href="index.jsp">首页</a><span>/</span><a href="#" class="on">校外访客</a><span>/</span><a href="rounding.jsp" class="on">景点介绍</a>
    </div>
</div><!-------------------current---------------------->
<div class="current">
    <div class="wrapper clearfix"><h3 class="fl">校外访客</h3>

    </div>
</div><!----------------proList------------------------->

<ul class="proList wrapper clearfix">
    <li><a href="https://www.cug.edu.cn/info/10452/88452.htm" target="_blank">
        <dl>
            <dt><img src="img/校园风景 (1).jpg"></dt>
            <dd>西区操场</dd>
        </dl>
    </a></li>
    <li><a href="https://www.cug.edu.cn/info/10452/91038.htm" target="_blank">
        <dl>
            <dt><img src="img/校园风景 (2).jpg"></dt>
            <dd>东区湖</dd>
        </dl>
    </a></li>
    <li><a href="https://www.cug.edu.cn/info/10452/88446.htm" target="_blank">
        <dl>
            <dt><img src="img/校园风景 (3).jpg"></dt>
            <dd>东区教学综合楼</dd>
        </dl>
    </a></li>
    <li><a href="https://www.cug.edu.cn/info/10452/91038.htm" target="_blank">
        <dl>
            <dt><img src="img/校园风景 (4).jpg"></dt>
            <dd>翠池</dd>
        </dl>
    </a></li>
    <li><a href="https://www.cug.edu.cn/info/10452/88454.htm" target="_blank">
        <dl>
            <dt><img src="img/校园风景 (5).jpg"></dt>
            <dd>院士长廊</dd>
        </dl>
    </a></li>
    <li><a href="https://www.cug.edu.cn/info/10452/89959.htm" target="_blank">
        <dl>
            <dt><img src="img/校园风景 (6).jpg"></dt>
            <dd>四重门</dd>
        </dl>
    </a></li>
    <li><a href="https://www.cug.edu.cn/info/10452/88444.htm" target="_blank">
        <dl>
            <dt><img src="img/校园风景 (7).jpg"></dt>
            <dd>西区图书馆</dd>
        </dl>
    </a></li>
    <li><a href="https://www.cug.edu.cn/info/10452/91039.htm" target="_blank">
        <dl>
            <dt><img src="img/校园风景 (8).jpg"></dt>
            <dd>北门</dd>
        </dl>
    </a></li>
    >
