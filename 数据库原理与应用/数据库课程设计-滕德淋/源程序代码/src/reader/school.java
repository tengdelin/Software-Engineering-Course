...
public class school {
    ...
    public school(int fid, String name, String maxclass, String midclass, String minclass, String address, String sheng, String shi, String qu, String name1, String xiaolei, String address1, String zhonglei, String dalei, String point) {
        this.fid = fid;
        this.name = name;
