...
<!-------------------reg-------------------------->
<div class="reg">
    <form action="/Wuhan_System/web_reg" method="post" onsubmit="return checkForm(this)">
        <h1 style="padding: 0px;margin: 0px;font-size: 25px;text-align: center;">
            <a href="index.jsp" >
            武汉房源查找系统
            </a>
        </h1>
        <p>
        <h1 style="padding: 0px;margin: 0px;font-size: 20px;background: rgb(64,129,197);text-align: center;color: #FFFFFF">
            用户注册</h1>
        </p>
