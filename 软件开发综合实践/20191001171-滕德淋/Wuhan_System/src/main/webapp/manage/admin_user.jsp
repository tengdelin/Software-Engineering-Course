...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <form action="/Wuhan_System/manage/admin_douserdel" id="myform" method="post">
            <div class="result-title">
                <div class="result-list">
                    <a href="admin_useradd.jsp">
                        <i class="icon-font"></i>新增用户
                    </a>
                    <a id="batchDel" href="javascript:delmore('你确定删除这些用户吗？','myform')">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <c:if test="${u.USER_STATUS==1}">
                                    ...
                                    <a class="link-del"
                                       href="javascript:Delete('你确定要删除用户【${u.USER_NAME}】吗？','/Wuhan_System/manage/admin_douserdel?id=${u.USER_ID}&cpage=${cpage}')">删除</a>
                                </c:if>
                                    <%--                                企业人员只可修改--%>
