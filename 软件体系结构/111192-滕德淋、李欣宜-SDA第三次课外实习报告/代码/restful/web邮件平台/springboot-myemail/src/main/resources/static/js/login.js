...
$('.modal-login form').addEventListener('submit', function (e) {
    ...
    $('.modal-login input[name=password]').value = md5($('.modal-login input[name=password]').value);
    this.submit()
})
$('.modal-register form').addEventListener('submit', function (e) {
    ...
    if (/^tdl$|^cug$/.test($('.modal-register input[name=username]').value)) {
    ...
    $('.modal-register input[name=password]').value = md5($('.modal-register input[name=password]').value);
    $('.modal-register input[name=password2]').value = md5($('.modal-register input[name=password2]').value);
